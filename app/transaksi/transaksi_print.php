...
@$available = "Menjual Alat-alat Bahan Bangunan";
@$nomer_telp_toko = "0251123456789";
?>
<!DOCTYPE html>
<html>
	...
	<table>
		<tr>
			<td colspan="4" align="center"><strong>
					<div class="pt"><?php echo $nama_toko; ?></div>
				</strong></td>
		</tr>
		<tr>
			<td colspan="4" align="center"><?php echo $available; ?></td>
		</tr>
		<tr>
			<td colspan="4" align="center"><?php echo $alamat_toko; ?><br><?php echo $nomer_telp_toko; ?></td>
		</tr>
		<tr>
			<td colspan="4">----------------------------------------------------
		</tr>
		...
		<tbody>
			...
			<tr>
				<td colspan="4" align="center">PERHATIAN !!!<br>BARANG YANG SUDAH DIBELI TIDAK BISA DITUKAR LAGI</td>
			</tr>
			<tr>
