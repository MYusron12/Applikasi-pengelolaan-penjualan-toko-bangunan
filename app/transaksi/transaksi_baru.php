						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" name="tkode" value="<?php if (@$_GET['id'] == "") {
																														echo @$r[0];
																													} else {
																														echo @$edit['kd_barang'];
																													} ?>" class="form-control" placeholder="Kode  Barang">
									<span class="input-group-btn">
										<button type="button" class="btn btn-primary <?php if (isset($_GET['edit'])) {
																																		echo 'enable';
																																	} ?>" data-toggle="modal" tabindex="0" <?php if (!isset($_GET['edit'])) {
																																																						echo "data-target='#barang'";
																																																					}
																																																					if (!isset($_GET['kd'])) {
																																																						echo "autofocus";
																																																					} ?>>Tampil</button>
							...
							<div class="form-group">
								...
								<div class="input-group">
									<span class="input-group-addon">
										<div class="glyphicon glyphicon-text-size"></div>
									</span>
									<input type="text" name="tbarang" value="<?php if (@$_GET['id'] == "") {
																															echo @$r['nama_barang'];
																														} else {
																															echo @$edit['barang'];
																														} ?>" required placeholder="Barang" class="form-control" readonly tabindex="1" autocomplete="off">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" name="tharga" id="tharga" value="<?php if (@$_GET['id'] == "") {
																																				echo @$r['harga_jual'];
																																			} else {
																																				echo @$edit['harga'];
																																			} ?>" required placeholder="Harga" class="form-control" readonly tabindex="1" autocomplete="off">
								</div>
							</div>
			...
			<div class="col-md-9">
				<div class="panel panel-primary">
					<div class="panel-heading" style="height:40px;">
						<h4 class="panel-title pull-left"><?php echo $nama_toko ?></h4>
					...
					<div class="panel-body">
						...
						<hr>
						<form method="post">
							<button type="button" id="pembayaran" class="btn btn-primary btn-block" data-toggle="modal" data-target="#bayar">
								<h4><b>P E M B A Y A R A N</b></h4>
							</button>
							<!-- Modalll -->
									...
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title" id="myModalLabel">
												<center>P E M B A Y A R A N</center>
											</h4>
										</div>
										<div class="modal-body">
											<form method="post">
							...
							<form method="post">
								<button type="submit" name="reset" class="btn btn-block btn-default" onclick="return confirm('Apakah Anda yakin akan mereset Transaksi ini ?');">
									<h4><b>R E S E T</b></h4>
								</button>
								<a href="?menu=daftarpenjualan" class="btn btn-block btn-default" onclick="return confirm('Apakah Anda yakin akan kembali ?');">
									<h4><b>K E M B A L I</b></h4>
								</a>
							<?php } ?>
							</form>
					</div>
