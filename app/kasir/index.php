...
<body>
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		...
		<div class="navbar-collapse collaspse">
			<ul class="nav navbar-nav">
				<li class="dropdown" id="hov">
					...
					<ul class="dropdown-menu" aria-labelledby="akun">
						...
						<li>
							<a href="index.php">
								<div class="glyphicon glyphicon-home"></div>&nbsp;&nbsp;Home Kasir
							</a>
						</li>
					</ul>
				</li>
			...
			<ul class="nav navbar-nav">
				<li class="dropdown" id="hov">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="transaksi">
						<div class="glyphicon glyphicon-shopping-cart"></div>&nbsp;&nbsp;TRANSAKSI&nbsp; <span class="caret"></span>
					</a>
	...
	switch (@$_GET['menu']) {
		case 'daftarpenjualan':
			include '../transaksi/daftar_penjualan.php';
			break;
		case 'penjualanbaru':
			include '../transaksi/transaksi_baru.php';
			break;
		case 'penjualanedit':
		...
		default:
			$aksi->alamat("index.php?menu=daftarpenjualan");
			break;
	}
	?>
