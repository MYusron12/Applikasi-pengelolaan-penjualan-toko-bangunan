...
switch ($bln) {
	case '1':
		@$bulaninitext = "Januari";
		break;
	case '2':
		@$bulaninitext = "Februari";
		break;
	case '3':
		@$bulaninitext = "Maret";
		break;
	...
	case '7':
		...
		break;
	case '8':
		@$bulaninitext = "Agustus";
		break;
	case '9':
		@$bulaninitext = "September";
		break;
	case '10':
		@$bulaninitext = "Oktober";
		break;
	case '11':
		@$bulaninitext = "Novemmber";
		break;
	case '12':
		@$bulaninitext = "Desember";
		break;
	default:
		@$bulaninitext = "";
		break;
...
<body onload="window.print()" style="font-family:'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma,  sans-serif;width:21cm;">
	<table width="100%" border="0" cellpadding="2" cellspacing="0">
		<thead>
			<tr>
				<td colspan="5">
					<h1 style="margin:0"><?php echo $nama_toko ?></h1>
					<h4 style="margin:0;margin-top:4px;"><?php echo $alamat_toko ?></h4>
				</td>
			</tr>
			...
			<tr>
				<td colspan="7" align="center">
					<h3 align="center">Daftar Pemasukan dan Pengeluaran Keuangan - Bulan <?php echo @$bulaninitext . " " . @$thn; ?></h3>
				</td>
			</tr>
