...
<body>
			...
			<ul class="nav navbar-nav">
				<li class="dropdown" id="hov">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="input">
						<div class="glyphicon glyphicon-edit"></div>&nbsp;&nbsp;KELOLA&nbsp; <span class="caret"></span>
					</a>
			...
			<ul class="nav navbar-nav">
				<li class="dropdown" id="hov">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="laporan">
						<div class="glyphicon glyphicon-duplicate"></div>&nbsp;&nbsp; LAPORAN <span class="caret"></span>
					</a>
	...
	switch (@$_GET['menu']) {
		case 'haladmin':
			...
			break;
		case 'daftarsupplier':
			include 'daftar_supplier.php';
			break;
		case 'daftaruser':
			include 'daftar_user.php';
			break;
		case 'daftarjenis':
			include 'daftar_jenis.php';
			break;
		case 'daftarbarang':
		...
		case 'profil':
			include '../laporan/profil.php';
			break;
		case 'lapuser':
			include '../laporan/laporan_user.php';
			break;
		case 'lapjenisbarang':
			include '../laporan/laporan_jenis.php';
			break;
		case 'lapsupplier':
			include '../laporan/laporan_supplier.php';
			break;
		case 'lapbarang':
			include '../laporan/laporan_barang.php';
			break;
		case 'lapbelibarang':
			include '../laporan/laporan_pembelian.php';
			break;
		case 'laptransaksiharian':
			include '../laporan/laporan_transaksi_harian.php';
			break;
		case 'laptransaksibulanan':
			include '../laporan/laporan_transaksi.php';
			break;
		case 'lapkeuangan':
			include '../laporan/laporan_keuangan.php';
			break;

		default:
			$aksi->alamat("index.php?menu=haladmin");
			break;
	}
	?>
	...
	<script>
		...
		$("#tdiskon").change(function() {
			...
			if (diskon == "10") {
				totalakhir = subtotal - (subtotal * 0.1)
			};
			if (diskon == "25") {
				totalakhir = subtotal - (subtotal * 0.25)
			};
			if (diskon == "50") {
				totalakhir = subtotal - (subtotal * 0.50)
			};
